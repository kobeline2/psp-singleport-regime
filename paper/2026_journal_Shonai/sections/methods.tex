...
PIV & Interrogation window & 000 $\rightarrow$ 000 pixel \\ % TODO: PIVlab_setting.mat 参照
PIV & Window overlap & 000\% \\ % TODO
PIV & Vector grid & 92 $\times$ 61 (spacing $\approx$ \SI{33}{mm}) \\
PIV & Image pair interval $\Delta t$ & \SIlist{0.200;0.100;0.067}{s} (inflow L/M/H), \SI{0.334}{s} (outflow) \\
PIV & Vector validation & PIVlab standard filters + NaN masking \\
Preprocessing & Flat-field / contrast & divide flat-field ($\sigma=\SI{30}{px}$), 1--99\% clip, invert \\
\hline
\end{tabular}
\end{table}
